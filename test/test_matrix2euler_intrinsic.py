...
def test_all_valid_axes():
    ...
    for axes in valid_axes:
        rotation_matrix = euler2matrix(eulers, axes=axes, intrinsic=True, right_handed_rotation=True)

        result_eulers = matrix2euler(rotation_matrix, axes=axes, right_handed_rotation=True,
                                     intrinsic=True)
        result_rotation_matrix = euler2matrix(result_eulers, axes=axes, intrinsic=True,
